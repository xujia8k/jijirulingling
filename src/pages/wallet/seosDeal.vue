<template>
  <div id="eos_deal">
    <Header>
      <template slot='conter'>SEOS明细</template>
    </Header>
    <div class="main">
      <div class="nav vux-1px-t">
        <span :class="{active:screenBtn}" @click='screenBtn=!screenBtn'>筛选<i></i></span>
        <span>时间<i></i></span>
      </div>
      ...
      .nav {
        ...
        > span {
          ...
          i {
            ...
            width: 23px;
            height: 13px;
            background: url("../../../static/images/sprite.png") no-repeat -430px -270px;
